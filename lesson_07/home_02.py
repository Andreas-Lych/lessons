"""
Известно, что на шахматной доске 8×8 можно расставить коней так, чтобы они не били друг друга (коней может ходить
буквой "Г" (3 + 1)). Вам дана расстановка двух коней на доске, определите могут ли кони бить друг друга.
